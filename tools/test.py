...
from mmocr.apis.test import multi_gpu_test, single_gpu_test, model_performance_summary
...
def parse_args():
    ...
    parser.add_argument(
        "--debugpy",
        action='store_true',
        help='Use debugpy module for debugging, default port is 5678'
    )
    ...
    parser.add_argument(
        "--visualize",
        action='store_true',
        help='Use SqlLogger to record the tensors or other information with global style.'
    )
    parser.add_argument('--local_rank', type=int, default=0)
    parser.add_argument('--model_performance_summary', action='store_true')
...
def main():
    ...
    if args.debugpy and args.local_rank == 0:
        print("debugging...")
        import debugpy
    ...
    if args.model_performance_summary:
        assert not distributed
        model = MMDataParallel(model, device_ids=[0])
        model_performance_summary(model, data_loader)
        return None
