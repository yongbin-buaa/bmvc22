...
class OCRDataset(BaseDataset):
    ...
    def evaluate(self, results, metric='acc', logger=None, convert_to_zhcn=False, **kwargs):
        ...
        eval_results = eval_ocr_metric(pred_texts, gt_texts, convert_to_zhcn=convert_to_zhcn)
