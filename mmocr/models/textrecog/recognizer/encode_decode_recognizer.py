...
class EncodeDecodeRecognizer(BaseRecognizer):
    ...
    def __init__(self,
        ...
        if SqlLogger.flag:
            SqlLogger.global_var["convertor"] = self.label_convertor
    ...
    def simple_test(self, img, img_metas, **kwargs):
        ...
        if SqlLogger.flag:
            SqlLogger.global_var["img"] = img.cpu().numpy()
            SqlLogger.global_var["target"] = img_metas[0]['text']
    ...
    def merge_aug_results(self, aug_results):
        ...
        for result in aug_results:
            ...
            if score > out_score:
                out_text = text
                out_score = score
        out_results = [dict(text=out_text, score=out_score, img_meta=result[0]['img_meta'])]
        return out_results
